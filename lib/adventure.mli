...
within the game. This type stores information about the character's name, role, 
health, strength, and special ability. *)
...
game including the name of the location, location description, and danger level 
of this location.  *)
...
the user to continuously update the state, storing information on the character, 
location, days survived, food, and gold amounts.  *)
...
terminal for how to proceed with the game including description of the choice 
and consequence or outcome for what will happen if they make that choice. *)
...
regarding that scenario. It stores a description of the scenario and the choices
the user can make regarding it. *)
...
(** [mystic_scenario] is a scenario involving encountering a mystic displayed 
to the user to choose options form. *)
